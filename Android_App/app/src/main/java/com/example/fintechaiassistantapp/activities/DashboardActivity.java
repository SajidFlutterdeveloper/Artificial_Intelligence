/*
 * Fintech AI Assistant - Dashboard Activity
 * Purpose: Main landing screen after login, managing navigation between Home, History, Trends, and Profile.
 * Architecture: Part of the View Layer in a Repository-based pattern.
 */
